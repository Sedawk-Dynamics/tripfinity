...
export default function NeemranaWeekendPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e27] via-[#1e3a5f] to-[#0a0e27]">
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/neemrana-fort-palace-heritage.jpg" alt="Neemrana Fort Palace" fill className="object-cover" priority />
          ...
          <Card className="bg-white p-8 shadow-2xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-5xl font-bold text-gold mb-2">₹69,999</p>
                <p className="text-gray-600">per group (4-5 friends)</p>
              </div>
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-2 text-gray-700"><Calendar className="h-5 w-5 text-gold" /><span>1 Night / 2 Days</span></div>
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-gold" /><span>Neemrana, Rajasthan</span></div>
      ...
      <section className="py-16 bg-white/5">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-white text-center mb-12">Your Royal Weekend</h2>
          <div className="space-y-8">
            {[
              { day: "Day 1", title: "Royal Arrival", desc: "Depart Delhi (3 hours). Traditional welcome at Neemrana Fort Palace. Explore the fort's many levels. Dinner under the stars on the terrace." },
              { day: "Day 2", title: "Leisure Redefined", desc: "Heritage suite breakfast. Pool lounging, spa treatments, or fort exploration. Late checkout at 4 PM and return to Delhi refreshed." }
            ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white p-6">
              ...
              <ul className="space-y-2 text-sm">
                {["Heritage suite accommodation", "Breakfast & dinner", "Pool access", "Guided fort tour", "Chauffeur-driven car", "Fuel & tolls"].map((item, idx) => (
            ...
            <Card className="bg-white p-6">
              ...
              <ul className="space-y-2 text-sm">
                {["Lunch", "Spa treatments", "Personal expenses", "Travel insurance", "Tips"].map((item, idx) => (
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl font-bold text-white mb-6">Experience Royal Luxury</h2>
          <div className="flex gap-4 justify-center">
            ...
            <Button asChild className="border-2 border-gold text-gold hover:bg-gold/10 px-8 py-6 bg-transparent">
              <a href="https://wa.me/919876543210?text=Hi,%20I'm%20interested%20in%20the%20Neemrana%20Luxury%20Friends'%20Escape" target="_blank" rel="noopener noreferrer">Contact Us on WhatsApp</a>
            </Button>
          </div>
        </div>
      </section>
