...
export default function RishikeshWeekendPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e27] via-[#1e3a5f] to-[#0a0e27]">
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/rishikesh-ganges-rafting.jpg" alt="Rishikesh Ganges" fill className="object-cover" priority />
          ...
          <Card className="bg-white p-8 shadow-2xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-5xl font-bold text-gold mb-2">₹29,999</p>
                <p className="text-gray-600">per group (4-6 friends)</p>
              </div>
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-gold" /><span>Rishikesh, Uttarakhand</span></div>
                <div className="flex items-center gap-2 text-gray-700"><Users className="h-5 w-5 text-gold" /><span>4-6 Friends</span></div>
              </div>
      ...
      <section className="py-16 bg-white/5">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-white text-center mb-12">Your Adventure Awaits</h2>
          <div className="space-y-8">
            {[
              { day: "Day 1", title: "Arrival & River Vibes", desc: "Drive from Delhi (5-6 hours). Check into riverside accommodation. Evening Ganga aarti ceremony and bonfire." },
              { day: "Day 2", title: "White Water Rafting & Yoga", desc: "Morning riverside yoga session. Adrenaline-pumping rafting adventure on the Ganges. Afternoon exploring cafés and Beatles Ashram." },
              { day: "Day 3", title: "Peaceful Return", desc: "Early morning meditation by the river. Leisurely breakfast and departure back to Delhi refreshed." }
            ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white p-6">
              ...
              <ul className="space-y-2 text-sm">
                {["2 nights accommodation", "Daily breakfast", "White water rafting", "Yoga session", "Bonfire evenings", "All transport"].map((item, idx) => (
            ...
            <Card className="bg-white p-6">
              ...
              <ul className="space-y-2 text-sm">
                {["Lunch & dinner", "Entry fees", "Personal expenses", "Travel insurance", "Optional activities"].map((item, idx) => (
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex gap-4 justify-center">
            ...
            <Button asChild className="border-2 border-gold text-gold hover:bg-gold/10 px-8 py-6 bg-transparent">
              <a href="https://wa.me/919876543210?text=Hi,%20I'm%20interested%20in%20the%20Rishikesh%20Friends'%20Weekend%20Escape" target="_blank" rel="noopener noreferrer">Contact Us on WhatsApp</a>
            </Button>
          </div>
        </div>
      </section>
