...
export default function JaipurWeekendPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0a0e27] via-[#1e3a5f] to-[#0a0e27]">
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/jaipur-hawa-mahal-pink-city.jpg" alt="Jaipur Pink City" fill className="object-cover" priority />
          ...
          <Card className="bg-white p-8 shadow-2xl">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              <div>
                ...
                <p className="text-5xl font-bold text-gold mb-2">₹34,999</p>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center gap-2 text-gray-700"><MapPin className="h-5 w-5 text-gold" /><span>Jaipur, Rajasthan</span></div>
      ...
      <section className="py-16 bg-white/5">
        <div className="container mx-auto px-4 max-w-4xl">
          <h2 className="text-4xl font-bold text-white text-center mb-12">Your Pink City Adventure</h2>
          <div className="space-y-8">
            {[
              { day: "Day 1", title: "Arrival & Evening Leisure", desc: "Drive from Delhi (5 hours). Explore local bazaars. Sunset at Nahargarh Fort. Dinner at rooftop restaurant with live music." },
              { day: "Day 2", title: "Heritage Walk & Café Hopping", desc: "Guided tour of City Palace, Hawa Mahal, Jantar Mantar. Afternoon café hopping in trendy neighborhoods. Evening shopping or nightlife." },
              { day: "Day 3", title: "Breakfast & Return", desc: "Leisurely breakfast. Quick souvenir shopping. Comfortable drive back to Delhi arriving by evening." }
            ].map((item, idx) => (
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="bg-white p-6">
              ...
              <ul className="space-y-2 text-sm">
                {["Private car throughout", "2 nights hotel with breakfast", "Guided heritage walk", "All transport", "24/7 support"].map((item, idx) => (
            ...
            <Card className="bg-white p-6">
              ...
              <ul className="space-y-2 text-sm">
                {["Lunch & dinner", "Entry fees", "Personal expenses", "Shopping", "Travel insurance"].map((item, idx) => (
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-4xl font-bold text-white mb-6">Experience the Pink City</h2>
          ...
          <a href="tel:+919220863958">    <Button asChild className="border-2 border-gold text-gold hover:bg-gold/10 px-8 py-6 bg-transparent">
              <a href="https://wa.me/919876543210?text=Hi,%20I'm%20interested%20in%20the%20Jaipur%20Friends'%20Weekend%20Escape" target="_blank" rel="noopener noreferrer">Contact Us on WhatsApp</a>
            </Button> </a>
          </div>
        </div>
      </section>
