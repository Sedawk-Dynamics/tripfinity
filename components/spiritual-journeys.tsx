...
const journeys = [
  ...
  },
  {
    ...
    tags: ["Packages", "Spiritual Journeys"],
    link: "/packages/vaishno-devi-express",
  },
  {
    id: 4,
    ...
    tags: ["Packages", "Spiritual Journeys"],
    link: "/packages/varanasi-kashi-darshan",
  },
]
          ...
          {journeys.map((journey, idx) => {
            const CardContent = (
              <motion.div
                ...
                className="group relative overflow-hidden rounded-2xl bg-white shadow-2xl hover:shadow-gold/30 transition-all duration-500 hover:-translate-y-2 cursor-pointer"
              >
            ...
            return journey.link ? (
              <Link key={journey.id} href={journey.link}>
                {CardContent}
              </Link>
            ) : (
              CardContent
